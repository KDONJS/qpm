<footer class="footer-modern">
    <div class="container">
                ...
                <div class="services-grid-footer">
                    <div class="services-column">
                        <ul class="footer-links-modern">
                            ...
                            <li><a href="<?php echo $basePath; ?>?page=inspeccion">Debe decir Inspección y Certificación de Equipos</a></li>
                        </ul>
                    </div>
                    <div class="services-column">
                        <ul class="footer-links-modern">
            ...
            <div class="footer-section-modern">
                ...
                <div class="contact-info-footer">
                    ...
                    <p class="contact-item-footer">
                        ...
                        <a href="https://wa.me/51940061321" target="_blank" rel="noopener">+51 940 061 321</a>
                    </p>
                    <p class="contact-item-footer">
        ...
        <div class="footer-bottom-modern">
            <p>&copy; 2025 <strong>QPM</strong></p>
        </div>
    </div>
</footer>
...
<a href="https://wa.me/51940061321" class="whatsapp-float" target="_blank" rel="noopener" aria-label="Contactar por WhatsApp">
